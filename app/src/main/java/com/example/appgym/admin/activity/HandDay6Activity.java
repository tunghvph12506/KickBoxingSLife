...
public class HandDay6Activity extends AppCompatActivity {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference databaseReference;
    RecyclerView recyclerView;
    ActionBar toolbar;
    String dataPath = "Exercise/Hand/Day6";
    String group = "Hand";
    String day = "Day6";
    String groupVn = "Tay";
    String dayVn = "Ngày 6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hand_day6);

        recyclerView = findViewById(R.id.rv_hand_day6);
        ...
        FirebaseRecyclerAdapter<Exercise, ViewHolder_Exercise> firebaseRecyclerAdapter
            ...
            protected void onBindViewHolder(@NonNull ViewHolder_Exercise holder, int position, @NonNull Exercise model) {
                holder.setItem(HandDay6Activity.this,model.getName(),model.getVideoUrl(),model.getImageUrl(),model.getSearch(),model.getCalo(),model.getDay());
            }
            ...
            public ViewHolder_Exercise onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewHolder_exercise.setOnClickListener(new ViewHolder_Exercise.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(HandDay6Activity.this, EditActivity.class);
                    ...
                    public void onItemLongClick(View view, int position) {
                        showAlertDialog(HandDay6Activity.this, position);
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.add_icon:
                Intent intent = new Intent(HandDay6Activity.this, AddActivity.class);
                startActivity(intent);
                return true;
