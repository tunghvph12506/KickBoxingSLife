...
public class StomachDay2Activity extends AppCompatActivity {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference databaseReference;
    RecyclerView recyclerView;
    ActionBar toolbar;
    String dataPath = "Exercise/Stomach/Day2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stomach_day2);

        recyclerView = findViewById(R.id.rv_stomach_day2);
        ...
        FirebaseRecyclerAdapter<Exercise, ViewHolder_Exercise> firebaseRecyclerAdapter
            ...
            protected void onBindViewHolder(@NonNull ViewHolder_Exercise holder, int position, @NonNull Exercise model) {
                holder.setItem(StomachDay2Activity.this,model.getName(),model.getVideoUrl(),model.getImageUrl(),model.getSearch(),model.getCalo(),model.getDay());
            }
            ...
            public ViewHolder_Exercise onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewHolder_exercise.setOnClickListener(new ViewHolder_Exercise.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(StomachDay2Activity.this, EditActivity.class);
                    ...
                    public void onItemLongClick(View view, int position) {
                        showAlertDialog(StomachDay2Activity.this, position);
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.add_icon:
                Intent intent = new Intent(StomachDay2Activity.this, AddActivity.class);
                startActivity(intent);
                return true;
