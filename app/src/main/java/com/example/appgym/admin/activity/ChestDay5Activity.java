...
public class ChestDay5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerAdapter<Exercise, ViewHolder_Exercise> firebaseRecyclerAdapter
            ...
            protected void onBindViewHolder(@NonNull ViewHolder_Exercise holder, int position, @NonNull Exercise model) {
                holder.setItem(ChestDay5Activity.this,model.getName(),model.getVideoUrl(),model.getImageUrl(),model.getSearch(),model.getCalo(),model.getDay());
            }
            ...
            public ViewHolder_Exercise onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewHolder_exercise.setOnClickListener(new ViewHolder_Exercise.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(ChestDay5Activity.this, EditActivity.class);
                    ...
                    public void onItemLongClick(View view, int position) {
                        showAlertDialog(ChestDay5Activity.this, position);
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.add_icon:
                Intent intent = new Intent(ChestDay5Activity.this, AddActivity.class);
                startActivity(intent);
                return true;
